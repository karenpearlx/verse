...
const FAQ: Item[] = [
  {
    ...
    a: [
      ...
      "Pro is ₱199 for 30 days, prepaid (no auto-renew). It unlocks unlimited letters and exports, every premium course (SEO, web development, and the other specialisms), early job access, interview prep and the follow-up writer. Pay with GCash, Maya, or card through PayMongo. Verse never takes a cut of your pay and is not an agency, so there is no placement fee either way.",
    ],
  },
  {
